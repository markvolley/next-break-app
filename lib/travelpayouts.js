...
export const REAL_DESTINATIONS = [
  ...
  { name: 'Port Douglas, AUS', iata: 'CNS', blurb: 'Reef, rainforest, relaxed tropical pace.' },
 ...
 */
export async function findRealDeals({ token, marker, origin, currency, brk, limit = 3, batchSize = 6, fetchImpl = fetch }) {
